...
class Partners
{
    ...
    {
        $res = $this->http->request('POST', '/v1/partners', [], $body, $options);
        return $res['data'];
    }

    public function get(string $partnerId): array
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId);
        return $res['data'];
    }
    ...
    {
        $res = $this->http->request('PUT', '/v1/partners/' . $partnerId, [], $body, $options);
        return $res['data'];
    }
    ...
    public function list(array $params = [], array $options = []): array
    {
        ...
        $res = $this->http->request('GET', '/v1/partners', $query, null, $options);
        return $res['data'];
    }

    public function deactivate(string $partnerId, array $options = []): array
    {
        $res = $this->http->request('POST', '/v1/partners/' . $partnerId . '/deactivate', [], null, $options);
        return $res['data'];
    }

    public function getReferralTree(string $partnerId): array
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId . '/hierarchy');
        return $res['data'];
    }
    ...
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId . '/referral-link');
        return $res['data'];
    }
    ...
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId . '/metrics', array_filter($opts));
        return $res['data'];
    }
    ...
    {
        $res = $this->http->request('GET', '/v1/partners/leaderboard', array_filter($opts));
        return $res['data'];
    }
    ...
    {
        $res = $this->http->request('POST', '/v1/partners/invite', [], $body, $options);
        return $res['data'];
    }

    public function resendInvite(string $partnerId, array $options = []): array
    {
        $res = $this->http->request('POST', '/v1/partners/' . $partnerId . '/resend-invite', [], null, $options);
        return $res['data'];
    }

    public function getOnboardingStatus(string $partnerId): array
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId . '/onboarding');
        return $res['data'];
    }

    public function sendAgreement(string $partnerId, string $templateId, array $options = []): array
    {
        $res = $this->http->request('POST', '/v1/partners/' . $partnerId . '/agreements/send', [], ['templateId' => $templateId], $options);
        return $res['data'];
    }

    public function getSignedDocuments(string $partnerId): array
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId . '/documents/signed');
        return $res['data'];
    }

    public function getAgreementStatus(string $partnerId): array
    {
        $res = $this->http->request('GET', '/v1/partners/' . $partnerId . '/agreement-status');
        return $res['data'];
    }
}
